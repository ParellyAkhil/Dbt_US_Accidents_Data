...
select distinct b.ADD_ID,z.DATE_ID,c.D_ID,d.R_ID,
a.WIND_CHILL_F_ as WIND_CHILL,a.SEVERITY as SEVERITY,a.HUMIDITY_ as HUMIDITY,a.PRESSURE_IN_ as PRESSURE,
a.VISIBILITY_MI_ as VISIBILITY,a.TEMPERATURE_F_ as TEMPERATURE,
...
from "DEVELOPER_DB"."AKHIL_SCHEMA"."STAGE_US_DATA" as a

left outer join "DEVELOPER_DB"."AKHIL_SCHEMA"."US_ACCIDENTS_ADRESS_DIM" b
on a.COUNTRY= b.COUNTRY and a.ZIPCODE= b.ZIPCODE and a.STATE=b.STATE
and a.COUNTY= b.COUNTY and a.CITY= b.CITY and a.STREET=b.STREET

left outer join "DEVELOPER_DB"."AKHIL_SCHEMA"."US_ACCIDENTS_DORN_DIM" c
...
left outer join "DEVELOPER_DB"."AKHIL_SCHEMA"."US_ACCIDENT_REASON_DIM" d
...
left outer join "DEVELOPER_DB"."AKHIL_SCHEMA"."US_CALENDAR_DATA"  as z
on a.DATE_ID=z.DATE_ID
where a._MODIFIED=b.LOAD_TIME and a._MODIFIED=c.LOAD_TIME and a._MODIFIED=d.LOAD_TIME
group by z.DATE_ID,c.D_ID,d.R_ID,b.ADD_ID,a.ID,a.SEVERITY,a.TEMPERATURE_F_,a.WIND_CHILL_F_,
